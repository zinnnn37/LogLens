...
public interface DashboardApi {
    ...
    @Operation(
            ...
            parameters = {
                    ...
                    @Parameter(
                            in = ParameterIn.QUERY,
                            name = "logLevel",
                            description = "로그 레벨 필터 (INFO, WARN, ERROR, ALL)",
                            required = false,
    ...
    @Operation(
            summary = "[임시] 프로젝트 메트릭 수동 집계",
            description = "배포 후 초기 데이터 생성을 위한 임시 API입니다. 최근 90일간의 LogMetrics와 HeatmapMetrics를 집계합니다. (배포 후 삭제 예정)",
            security = @SecurityRequirement(name = "bearerAuth"),
            parameters = {
                    @Parameter(
                            in = ParameterIn.PATH,
            ...
            responses = {
                    ...
                    @ApiResponse(
                                            ...
                                            value = """
                        {
                            ...
                            "message": "입력값이 유효하지 않습니다",
                            "status": 400,
                            "timestamp": "2025-11-14T17:45:30Z"
                        }
                        """
                                    )
                            )
                    ...
                    @ApiResponse(
                            ...
                            content = @Content(
                                    ...
                                    examples = @ExampleObject(
                                            ...
                                            summary = "집계 실패",
                                            value = "실패: OpenSearch 연결 오류"
                                    )
                            )
                    )
            }
    )
    ResponseEntity<String> manualAggregate(
