...
public class ApiEndpointServiceImpl implements ApiEndpointService {
     ...
     */
    @Override
    public ApiEndpointResponse getApiEndpoint(Integer projectId, String startTime, String endTime, Integer limit) {
        log.info("{} API 통계 조회 시작: projectId={}, limit={}", LOG_PREFIX, projectId, limit);

        // 프로젝트 권한 검증
        dashboardValidator.validateProjectAccess(projectId);
        ...
        int queryLimit = (limit != null) ? limit : DEFAULT_LIMIT;
