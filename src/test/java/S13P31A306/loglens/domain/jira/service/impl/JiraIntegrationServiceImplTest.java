...
class JiraIntegrationServiceImplTest {
    ...
    @Mock
    private S13P31A306.loglens.domain.jira.service.JiraConnectionTransactionService connectionTransactionService;
    ...
    class ConnectTest {
        ...
        void Jira_연동_성공_시_JiraConnectResponse를_반환한다() {
            ...
            // JiraConnectionTestResponse 직접 생성
            ...
            given(jiraApiClient.testConnection(jiraUrl, jiraEmail, jiraApiToken, jiraProjectKey))
                    .willReturn(true);
            given(connectionTransactionService.saveConnection(request, projectId, projectUuid, encryptedToken))
            ...
            verify(connectionTransactionService, times(1)).saveConnection(request, projectId, projectUuid, encryptedToken);
        }
        ...
        void 긴_API_토큰_암호화_후_저장_성공() {
            ...
            given(jiraApiClient.testConnection(jiraUrl, jiraEmail, longJiraApiToken, jiraProjectKey))
                    .willReturn(true);
            given(connectionTransactionService.saveConnection(request, projectId, projectUuid, encryptedLongToken))
                    .willReturn(expectedResponse);
            ...
            verify(connectionTransactionService, times(1)).saveConnection(request, projectId, projectUuid, encryptedLongToken);
        }
